			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="project.town.label" default="Town" /></th>
				...
				<g:each in="${projectInstanceList}" status="i" var="projectInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${projectInstance.id}">${fieldValue(bean: projectInstance, field: "endDate")}</g:link></td>
					
						<td>${fieldValue(bean: projectInstance, field: "name")}</td>
					
						<td><g:formatDate date="${projectInstance.startDate}" /></td>
					
						<td>${fieldValue(bean: projectInstance, field: "town")}</td>
